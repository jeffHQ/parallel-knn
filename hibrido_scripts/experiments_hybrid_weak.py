...
def main():
    ...
    # ----------------- CONFIGURACIÓN -----------------
    # Ajusta esto según lo que quieras probar
    # (luego puedes cambiarlo desde la línea de comandos
    #  si prefieres, pero para mantenerlo simple lo dejamos fijo aquí)
    n_threads = 2        # hilos por proceso
    base_frac = 0.25     # fracción base para W = 1
    k = 3
    ...
    # Fracción de dataset según W (saturada en 1.0)
    frac = base_frac * W
    if frac > 1.0:
        frac = 1.0
    ...
    if rank == 0 and metrics is not None:
        ...
        print("p,threads,W,frac,n_train,n_test,k,acc,"
              "T_total,T_comp,T_comm,workload,time_per_pair")
